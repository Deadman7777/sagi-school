...
PLAN_COMPTABLE = {
    ...
    '6718':  'Autres charges financières',
    ...
    '7588':  'Dons, partenariats et autres produits divers',
...
class BudgetView(APIView):
    ...
    def _realise_par_mois(self, tenant, exercice, ligne):
        """Voir apps.comptabilite.budget.realise_par_mois — source unique,
        partagée avec le cahier mensuel et le tableau de bord."""
        from .budget import realise_par_mois
        return realise_par_mois(tenant, exercice, ligne)
