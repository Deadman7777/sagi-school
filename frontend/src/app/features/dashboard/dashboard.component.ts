  ...
  template: `
    ...
    <ng-container *ngIf="!isSuperAdmin()">
      ...
      <div class="kpi-card" style="--acc:#10b981">
        ...
        <div class="kpi-value" style="color:#10b981">{{ data()?.kpis?.taux_recouvrement || 0 }}%</div>
      ...
      <div class="kpi-card" style="--acc:#ef4444">
        ...
        <div class="kpi-value" style="color:#ef4444">{{ data()?.kpis?.total_impayes || 0 }} FCFA</div>
      ...
      <div class="kpi-card" style="--acc:#a855f7">
        ...
        <div class="kpi-value" style="color:#a855f7">{{ data()?.kpis?.total_attendu || 0 }} FCFA</div>
